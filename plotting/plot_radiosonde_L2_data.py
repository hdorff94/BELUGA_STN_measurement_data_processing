...
def plot_sonde_period(sonde_df):
    ...
    for d, date in enumerate(launch_dates):
        ...
        C1=ax1.scatter(np.repeat(date,altitude.shape[0]),
            ...
            c=sonde_day["Theta"].values,vmin=250,vmax=300,
            cmap="Spectral_r",s=500, marker="_") # default s=100
        C2=ax2.scatter(
            np.repeat(date,altitude.shape[0]),
            altitude.values/1000,
            c=sonde_day["RH"].values,vmin=0,vmax=100,
            cmap="Blues",s=500, marker="_")
        C3=ax3.scatter(np.repeat(date,altitude.shape[0]),
            altitude.values/1000,
            c=wspeed.values,vmin=0,vmax=25,
            cmap="viridis",s=500, marker="_")
    ...
    fig_name = "fig09_radiosondes_campaign.png"
...
radiosonde_l2_path="C://Users//u300737//Desktop//Desktop_alter_Rechner//"+\
